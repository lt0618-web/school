<template>
	...
	<cell>
		...
		>
			...
			<uni-icons v-if="showArrow || link" :size="rightIcon.size" class="uni-icon-wrapper" type="arrowright" :color="rightIcon.color" />
		</view>
		<!-- #ifdef APP-NVUE -->
	</cell>
	<!-- #endif -->
 ...
 * @property {Object} 	rightIcon 						扩展图标参数，格式为 {color: '#4cd964',size: '22'}
